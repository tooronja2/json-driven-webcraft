  ...
  return (
    <>
      ...
      <main className="bg-zinc-50 min-h-screen pt-2">
        <section
          ref={formRef}
          className={`max-w-6xl mx-auto my-8 md:my-16 px-4 md:px-8 transition-all duration-700 ${
            formVisible ? "animate-fade-in opacity-100" : "opacity-0 translate-y-10"
          }`}
        >
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 text-center text-zinc-900">
            Reservá tu turno
          </h1>
          <GoogleFormEmbed formUrl={GOOGLE_CALENDAR_URL} />
          <p className="mx-auto mt-3 max-w-lg text-center text-gray-600 text-sm md:text-md px-4">
